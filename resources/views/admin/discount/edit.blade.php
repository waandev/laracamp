                        ...
                        <form action="{{ route('admin.discount.update', $discount->id) }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="description" id="" cols="0" rows="2"
                                    class="form-control form-control {{ $errors->has('description') ? 'is_invalid' : '' }}">{{ old('description') ?: $discount->description }}</textarea>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="percentage" type="number"
                                    ...
                                    min="1" max="100" value="{{ old('percentage') ?: $discount->percentage }}"
                                    required>
